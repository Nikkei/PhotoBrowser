...
class PhotoTransition: UIPercentDrivenInteractiveTransition {
    ...
    func transition(_ show: Bool) {
        guard let controller = PhotoBrowser else { return }
    ...
    override func finish() {
        ...
        PhotoBrowser.dismissalDelegate?.PhotoBrowserWillDismiss(PhotoBrowser)
    }
}

// MARK: - UIViewControllerAnimatedTransitioning

extension PhotoTransition: UIViewControllerAnimatedTransitioning {
...
extension PhotoTransition: UIViewControllerTransitioningDelegate {
...
extension PhotoTransition: UIGestureRecognizerDelegate {
