...
class PageView: UIScrollView {
    ...
    lazy var playButton: UIButton = {
        ...
        button.setBackgroundImage(PhotoAssetManager.image("play"), for: UIControl.State())
    ...
    func configure() {
        ...
        minimumZoomScale = PhotoConfig.Zoom.minimumScale
        maximumZoomScale = PhotoConfig.Zoom.maximumScale
    ...
    func makeActivityIndicator() -> UIActivityIndicatorView {
        ...
        PhotoConfig.LoadingIndicator.configure?(view)
        view.startAnimating()
